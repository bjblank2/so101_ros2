...
# Adapted for kiwi_robot - Feetech motor control tables

FIRMWARE_MAJOR_VERSION = (0, 1)
FIRMWARE_MINOR_VERSION = (1, 1)
MODEL_NUMBER = (3, 2)  # Address and length tuple for reading model number
...
# Note: MODEL_NUMBER_TABLE and MODEL_RESOLUTION are already defined above
